...
- Minimum answer length: 1 mark = 40+ words, 2 marks = 80+ words, 5 marks = 160+ words, 10 marks = 240+ words.
- If the topic supports formulas, include at least one formula and explain each symbol.
- If the topic supports code or algorithms, include a short code snippet or pseudo-code with brief explanation when helpful.
...
- For 5+ marks, include: (a) 3-5 bullet points, (b) at least one formula or equation, (c) a brief limitation/assumption, (d) a short application/example.
